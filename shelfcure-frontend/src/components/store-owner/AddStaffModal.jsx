...
const AddStaffModal = ({ isOpen, onClose, stores, onStaffAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`/api/store-owner/stores/${formData.storeId}/staff`, {
        method: 'POST',
        headers: {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900 text-left">Add Staff Member</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 text-left">
                  Default password: ShelfCure@123
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-gray-900 text-left">Role & Store Assignment</h3>
